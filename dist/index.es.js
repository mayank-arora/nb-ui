        ...
        React.createElement("div", null,
            ...
            React.createElement("div", { className: styles.itemCtn },
                config.showDashboard &&
                    !(active === 'compliance' || active === 'training' || active === 'course') && (React.createElement(NavItem, { active: active === 'dashboard', href: '/dashboard', title: 'Dashboard' }, active === 'dashboard' ? (React.createElement("img", { src: img$e })) : (React.createElement("img", { src: img$i })))),
                ...
                config.showTask &&
                    !(active === 'compliance' || active === 'training' || active === 'course') && (React.createElement(NavItem, { active: active === 'task', href: '/task', title: 'Task' }, active === 'task' ? (React.createElement("img", { src: img$5 })) : (React.createElement("img", { src: img$6 })))),
                ...
                config.showTeam &&
                    !(active === 'compliance' || active === 'training' || active === 'course') && (React.createElement(NavItem, { active: active === 'teamdirectory', href: '/teamdirectory', title: 'Team' }, active === 'teamdirectory' ? (React.createElement("img", { src: img$b })) : (React.createElement("img", { src: img$c })))),
                ...
                config.showSchedule &&
                    !(active === 'compliance' || active === 'training' || active === 'course') && (React.createElement(NavItem, { active: active === 'schedule', href: '/schedule', title: 'Engage - Unicasts' }, active === 'schedule' ? (React.createElement("img", { src: img$9 })) : (React.createElement("img", { src: img$a })))),
