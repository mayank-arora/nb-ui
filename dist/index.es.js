    ...
    return (React.createElement("div", { className: styles.itemCtn },
        config.showDashboard &&
            (active === 'boards' ||
                ...
                active === 'schedule') && (React.createElement(NavItem, { active: active === 'dashboard', href: '/dashboard', title: 'Dashboard' }, active === 'dashboard' ? (React.createElement("img", { src: img$d })) : (React.createElement("img", { src: img$h })))),
        React.createElement(NavItem, { active: active === 'boards', href: '/boards', title: 'Boards' }, active === 'boards' ? (React.createElement("img", { src: img$e })) : (React.createElement("img", { src: img$c }))),
        config.showTask &&
            (active === 'boards' ||
                active === 'dashboard' ||
                active === 'task' ||
                active === 'teamdirectory' ||
                active === 'schedule') && (React.createElement(NavItem, { active: active === 'task', href: '/task', title: 'Task' }, active === 'task' ? (React.createElement("img", { src: img$4 })) : (React.createElement("img", { src: img$5 })))),
        config.showAdmin && (React.createElement(NavItem, { active: active === 'import-export', href: '/import-export', title: 'Export/Import' }, active === 'import-export' ? (React.createElement("img", { src: img$f })) : (React.createElement("img", { src: img$g })))),
        config.showTeam &&
            (active === 'boards' ||
                active === 'dashboard' ||
                active === 'task' ||
                active === 'teamdirectory' ||
                active === 'schedule') && (React.createElement(NavItem, { active: active === 'teamdirectory', href: '/teamdirectory', title: 'Team' }, active === 'teamdirectory' ? (React.createElement("img", { src: img$a })) : (React.createElement("img", { src: img$b })))),
        config.showTraining && (React.createElement(NavItem, { active: active === 'training' || active === 'course', href: '/training', title: 'Manage Training' }, active === 'training' ? (React.createElement("img", { src: img$2 })) : (React.createElement("img", { src: img$3 })))),
        config.showAcademy && (React.createElement(NavItem, { active: active === 'academy', href: '/academy', title: 'Learning Academy' }, active === 'academy' ? (React.createElement("img", { src: img })) : (React.createElement("img", { src: img$1 })))),
        config.showSchedule &&
            (active === 'boards' ||
                active === 'dashboard' ||
                active === 'task' ||
                active === 'teamdirectory' ||
                active === 'schedule') && (React.createElement(NavItem, { active: active === 'schedule', href: '/schedule', title: 'Engage - Unicasts' }, active === 'schedule' ? (React.createElement("img", { src: img$8 })) : (React.createElement("img", { src: img$9 })))),
        config.showChecklist && (React.createElement(NavItem, { active: active === 'compliance', href: team.id === '1' || team.plan === 'trial'
                ? '/compliance'
                : '/checklist', title: 'Checklists' }, active === 'compliance' ? (React.createElement("img", { src: img$6 })) : (React.createElement("img", { src: img$7 }))))));
};
...
var Navbar = function (_a) {
    ...
    var _g = useState(user.name), userName = _g[0], setUserName = _g[1];
    // const [profileHover, setProfileHover] = useState(false)
    return (React.createElement("div", { className: styles.ctn },
        React.createElement("div", null,
            React.createElement("div", { className: styles.logoCtn },
                React.createElement("a", { href: '/team' }, team.logo ? (React.createElement("img", { className: styles.logo, src: cloudinaryUrl(team.logo), alt: '' })) : (React.createElement(DefaultLogo, { id: team.id, name: team.name })))),
        ...
        React.createElement("div", { className: styles.profileCtn },
            React.createElement(Dropdown, { destroyPopupOnHide: true, overlay: React.createElement(ProfileMenu, __assign({}, { setProfileVisible: setProfileVisible })) },
                React.createElement("img", { className: styles.logo, src: user.profilePic ? cloudinaryUrl(user.profilePic) : img$i, alt: '' })),
            React.createElement(Modal, { title: 'Update Profile', visible: profileVisible, onOk: function () {
                ...
                React.createElement("div", { className: styles.modal },
                    React.createElement("div", { className: styles.imageCtn },
                        React.createElement(Upload, { showUploadList: false, onChange: uploadFile }, user.profilePic ? (React.createElement("img", { src: user.profilePic ? cloudinaryUrl(user.profilePic) : img$i, alt: '' })) : (React.createElement(DefaultLogo, { alternate: true, id: team.id, name: team.name })))),
