...
var ItemContainer = function (_a) {
    ...
    return (React.createElement("div", { className: styles.itemCtn },
        config.showDashboard &&
            !(active === 'compliance' ||
                active === 'training' ||
                active === 'course') && (React.createElement(NavItem, { active: active === 'dashboard', href: '/dashboard', title: 'Dashboard' }, active === 'dashboard' ? (React.createElement("img", { src: img$d })) : (React.createElement("img", { src: img$h })))),
        ...
        config.showTask &&
            !(active === 'compliance' ||
                active === 'training' ||
                active === 'course') && (React.createElement(NavItem, { active: active === 'task', href: '/task', title: 'Task' }, active === 'task' ? (React.createElement("img", { src: img$4 })) : (React.createElement("img", { src: img$5 })))),
        ...
        config.showTeam &&
            !(active === 'compliance' ||
                active === 'training' ||
                active === 'course') && (React.createElement(NavItem, { active: active === 'teamdirectory', href: '/teamdirectory', title: 'Team' }, active === 'teamdirectory' ? (React.createElement("img", { src: img$a })) : (React.createElement("img", { src: img$b })))),
        ...
        config.showSchedule &&
            !(active === 'compliance' ||
                active === 'training' ||
                active === 'course') && (React.createElement(NavItem, { active: active === 'schedule', href: '/schedule', title: 'Engage - Unicasts' }, active === 'schedule' ? (React.createElement("img", { src: img$8 })) : (React.createElement("img", { src: img$9 })))),
        config.showChecklist && (React.createElement(NavItem, { active: active === 'compliance', href: '/compliance', title: 'Checklists' }, active === 'compliance' ? (React.createElement("img", { src: img$6 })) : (React.createElement("img", { src: img$7 }))))));
};
...
var Navbar = function (_a) {
    ...
    return (React.createElement("div", { className: styles.ctn },
        React.createElement("div", null,
            ...
            router && list ? (list()) : (React.createElement(ItemContainer, { config: config, active: active }))),
                ...
                React.createElement("div", { className: styles.modal },
                    React.createElement("div", { className: styles.imageCtn },
                        React.createElement(Upload, { showUploadList: false, onChange: uploadFile },
                            React.createElement("img", { src: user.profilePic ? cloudinaryUrl(user.profilePic) : img$i, alt: '' }))),
