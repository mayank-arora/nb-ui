    ...
    return (React.createElement("div", { className: styles.ctn },
        React.createElement("div", null,
            ...
            React.createElement("div", { className: styles.itemCtn },
                config.showDashboard && (React.createElement(NavItem, { href: '/dashboard', title: 'Dashboard' }, (React.createElement("img", { src: img$9 })))),
                React.createElement(NavItem, { href: '/boards', title: 'Boards' }, React.createElement("img", { src: img$7 })),
                config.showTask && (React.createElement(NavItem, { href: '/task', title: 'Task' }, React.createElement("img", { src: img$3 }))),
                config.showAdmin && (React.createElement(NavItem, { href: '/import-export', title: 'Export/Import' }, (React.createElement("img", { src: img$8 })))),
                config.showTeam && (React.createElement(NavItem, { href: '/teamdirectory', title: 'Team' }, React.createElement("img", { src: img$6 }))),
                config.showTraining && (React.createElement(NavItem, { href: '/training', title: 'Manage Training' }, (React.createElement("img", { src: img$2 })))),
                config.showAcademy && (React.createElement(NavItem, { href: '/academy', title: 'Learning Academy' }, (React.createElement("img", { src: img$1 })))),
                config.showSchedule && (React.createElement(NavItem, { href: '/schedule', title: 'Engage - Unicasts' }, (React.createElement("img", { src: img$5 })))),
                config.showChecklist && (React.createElement(NavItem, { href: '/compliance', title: 'Checklists' }, (React.createElement("img", { src: img$4 })))))),
