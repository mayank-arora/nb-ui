...
function DefaultLogo(_a) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null, profilePic ? (React__default["default"].createElement("img", { className: large ? styles.logoLarge : styles.logo, src: cloudinaryUrl(profilePic), alt: '' })) : (React__default["default"].createElement("div", { style: {
    ...
    return (React__default["default"].createElement("div", { className: styles.itemCtn },
        config.showDashboard &&
            (active === 'boards' ||
                ...
                active === 'schedule') && (React__default["default"].createElement(NavItem, { active: active === 'dashboard', href: '/dashboard', title: 'Dashboard' }, active === 'dashboard' ? (React__default["default"].createElement("img", { src: img$b })) : (React__default["default"].createElement("img", { src: img$f })))),
        React__default["default"].createElement(NavItem, { active: active === 'boards', href: '/boards', title: 'Boards' }, active === 'boards' ? (React__default["default"].createElement("img", { src: img$c })) : (React__default["default"].createElement("img", { src: img$a }))),
        config.showTask &&
            (active === 'boards' ||
                active === 'dashboard' ||
                active === 'task' ||
                active === 'teamdirectory' ||
                active === 'schedule') && (React__default["default"].createElement(NavItem, { active: active === 'task', href: '/task', title: 'Task' }, active === 'task' ? (React__default["default"].createElement("img", { src: img$2 })) : (React__default["default"].createElement("img", { src: img$3 })))),
        config.showAdmin && (React__default["default"].createElement(NavItem, { active: active === 'import-export', href: '/import-export', title: 'Export/Import' }, active === 'import-export' ? (React__default["default"].createElement("img", { src: img$d })) : (React__default["default"].createElement("img", { src: img$e })))),
        config.showTeam &&
            (active === 'boards' ||
                active === 'dashboard' ||
                active === 'task' ||
                active === 'teamdirectory' ||
                active === 'schedule') && (React__default["default"].createElement(NavItem, { active: active === 'teamdirectory', href: '/teamdirectory', title: 'Team' }, active === 'teamdirectory' ? (React__default["default"].createElement("img", { src: img$8 })) : (React__default["default"].createElement("img", { src: img$9 })))),
        config.showTraining && (React__default["default"].createElement(NavItem, { active: active === 'training' || active === 'course', href: '/training', title: 'Manage Training' }, active === 'training' ? (React__default["default"].createElement("img", { src: img })) : (React__default["default"].createElement("img", { src: img$1 })))),
        config.showSchedule &&
            (active === 'boards' ||
                active === 'dashboard' ||
                active === 'task' ||
                active === 'teamdirectory' ||
                active === 'schedule') && (React__default["default"].createElement(NavItem, { active: active === 'schedule', href: '/schedule', title: 'Engage - Unicasts' }, active === 'schedule' ? (React__default["default"].createElement("img", { src: img$6 })) : (React__default["default"].createElement("img", { src: img$7 })))),
        config.showChecklist && (React__default["default"].createElement(NavItem, { active: active === 'compliance', href: team.id === '1' || team.plan === 'trial'
                ? '/compliance'
                : '/checklist', title: 'Checklists' }, active === 'compliance' ? (React__default["default"].createElement("img", { src: img$4 })) : (React__default["default"].createElement("img", { src: img$5 }))))));
};
...
var Navbar = function (_a) {
    ...
    var _f = React.useState(), newImage = _f[0], setNewImage = _f[1];
    var _g = React.useState(false), profileVisible = _g[0], setProfileVisible = _g[1];
    var _h = React.useState(true), imageUploading = _h[0], setImageUploading = _h[1];
    var _j = React.useState(user.name), userName = _j[0], setUserName = _j[1];
    var _k = React.useState(false), profileHover = _k[0], setProfileHover = _k[1];
    ...
    return (React__default["default"].createElement("div", { className: styles.ctn },
        React__default["default"].createElement("div", null,
            React__default["default"].createElement("div", { className: styles.logoCtn },
                React__default["default"].createElement("a", { href: '/team' },
                    React__default["default"].createElement(DefaultLogo, { id: team.id, name: team.name, profilePic: team.logo }))),
        ...
        React__default["default"].createElement("div", { className: styles.profileCtn },
            React__default["default"].createElement(antd.Dropdown, { destroyPopupOnHide: true, overlay: React__default["default"].createElement(ProfileMenu, __assign({}, { setProfileVisible: setProfileVisible })) },
                React__default["default"].createElement("div", null,
                    React__default["default"].createElement(DefaultLogo, { id: user.id, name: user.name, profilePic: newImage ? newImage : user.profilePic }))),
            React__default["default"].createElement(antd.Modal, { width: 720, title: 'Update Profile', visible: profileVisible, footer: null, onCancel: function () { return setProfileVisible(false); }, okText: 'Update Profile' },
                React__default["default"].createElement("div", { className: styles.modal },
                    React__default["default"].createElement("div", { className: styles.details },
                        React__default["default"].createElement("div", { className: styles.imageCtn },
                            React__default["default"].createElement("div", { onMouseEnter: function () { return setProfileHover(true); }, onMouseLeave: function () { return setProfileHover(false); } },
                                React__default["default"].createElement(antd.Upload, { showUploadList: false, onChange: uploadFile },
                                    profileHover && !imageUploading && (React__default["default"].createElement("div", { className: styles.hoverEdit },
                                        React__default["default"].createElement("img", { src: img$g, alt: '', style: { width: 35, height: 35 } }))),
                                    imageUploading && (React__default["default"].createElement("div", { className: styles.hoverEdit },
                                        React__default["default"].createElement(antd.Spin, null))),
                                    React__default["default"].createElement(DefaultLogo, { alternate: true, id: user.id, name: user.name, large: true, profilePic: newImage ? newImage : user.profilePic })),
                                React__default["default"].createElement("p", { style: {
                                        marginTop: 8,
                                        fontSize: 12,
                                        opacity: 0.8,
                                        textAlign: 'center',
                                    } }, "Add/Edit picture"))),
                        React__default["default"].createElement("div", { className: styles.contactCtn },
